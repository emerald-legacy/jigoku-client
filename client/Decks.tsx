...
export function InnerDecks({
    ...
    const deckListSkeleton = Array.from({ length: 6 }, (_value, index) => (
        <div className="deck-row deck-row-skeleton" key={ `skeleton-${index}` } aria-hidden="true">
            <div className="deck-row-clans">
                <span className="deck-skeleton-block deck-skeleton-clan" />
            </div>
            <span className="deck-row-name">
                <span className="deck-skeleton-block deck-skeleton-name" />
            </span>
            <span className="deck-row-status deck-skeleton-block deck-skeleton-status" />
        </div>
    ));
                        ...
                        { hasDecks && (
                            <div className="checkbox" style={ { marginTop: "10px", marginBottom: "10px" } }>
                                <label>
                                    <input
                                        type="checkbox"
                                        checked={ selectedDeckIds.length === deckCount }
